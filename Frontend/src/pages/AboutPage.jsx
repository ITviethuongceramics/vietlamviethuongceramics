      ...
      <section className="about-intro">
        <div className="about-intro__text" data-reveal>
          ...
          <h2 className="about-intro__heading">
            GIỚI THIỆU VIET HUONG CERAMICS<br />
            <span>DOANH NGHIỆP "SAO VÀNG ĐẤT VIỆT" 2024</span>
          </h2>
          <p>
            Trong hành trình phát triển của ngành vật liệu xây dựng Việt Nam, Công ty Cổ phần Xây
            dựng Gốm Sứ Việt Hương (Viet Huong Ceramics) từng bước khẳng định vai trò là một doanh
            nghiệp tiên phong trong lĩnh vực sản xuất, kinh doanh và xuất nhập khẩu vật liệu xây
            dựng, gốm sứ – gạch ốp lát, đồng thời mở rộng hoạt động trong logistics và dịch vụ
            thương mại quốc tế.
          </p>
          <p>
            Doanh nghiệp kiên định theo đuổi mục tiêu xây dựng một hệ sinh thái doanh nghiệp hiện
            đại, minh bạch và có năng lực cạnh tranh trên thị trường toàn cầu, thông qua việc liên
            tục đầu tư công nghệ, nâng cao năng lực sản xuất và hoàn thiện chất lượng sản phẩm.
          </p>
          <p>
            Lấy triết lý{' '}
            <strong>"Chất lượng – Uy tín – Phát triển bền vững"</strong> làm kim chỉ nam cho mọi
            hoạt động, Viet Huong Ceramics không chỉ tập trung cung cấp các sản phẩm vật liệu xây
            dựng chất lượng cao mà còn phát triển mạnh các dịch vụ hỗ trợ thương mại, logistics và
            xuất nhập khẩu.
          </p>
          <div className="about-intro__pill">
            <span>Tiên phong · Minh bạch · Bền vững</span>
          </div>
        </div>
        <div className="about-intro__image" data-reveal>
          <div className="about-intro__image-frame">
            <img
              src="https://viethuongceramics.com/wp-content/smush-webp/2023/10/KPEBM157003-3.jpg.webp"
              alt="Viet Huong Ceramics showroom"
            />
      ...
      <section className="about-vision">
        ...
        <div className="about-vision__content" data-reveal>
          <div className="about-vision__block">
            ...
            <h2 className="about-vision__label">Tầm Nhìn</h2>
            <ul>
              <li>Là doanh nghiệp dẫn đầu Việt Nam về nhập khẩu và xuất khẩu Vật liệu xây dựng, cung cấp sản phẩm chất lượng cao đáp ứng nhu cầu của khách hàng và người tiêu dùng.</li>
              <li>Xây dựng mối quan hệ chiến lược với các công ty xây dựng và kiến trúc, nhà thầu hàng đầu Việt Nam</li>
              <li>Cung cấp các giải pháp vật liệu xây dựng tiên tiến và sản phẩm xanh bảo vệ môi trường.</li>
            </ul>
          </div>
          ...
          <div className="about-vision__block about-vision__block--mission">
            ...
            <h2 className="about-vision__label about-vision__label--right">Sứ Mệnh</h2>
            <p>
              Việt Hương không ngừng sáng tạo nghiên cứu để mang lại những sản phẩm chất lượng tốt
              nhất trên thế giới đến với người tiêu dùng Việt Nam
            </p>
